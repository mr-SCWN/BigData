...
with DAG(
  ...
  mapreduce_classic = BashOperator(
    ...
    bash_command="""hadoop jar {{ params.dags_home }}/project_files/IMDBRoleCount.jar {{ params.input_dir }}/datasource1 {{ params.output_mr_dir }}""",
  )
...
... """,
  ...
  hive = BashOperator(
    ...
    bash_command="""beeline -u jdbc:hive2://localhost:10000/default \
      -f {{ params.dags_home }}/project_files/process_top_persons.hql \
